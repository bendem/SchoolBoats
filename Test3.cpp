...
int main() {
    ...
    { // A faire aussi : la methode toString() qui n'affiche rien mais qui retourne un objet string !!!
        ...
        cout << "d (par defaut) = " << d.toString() << endl;
        Moment delai(10), delai1(143); // constructeur d'initialisation
        cout << "delai (initialisation de 10 minutes) = " << delai.toString() << endl;
        cout << "delai1 (initialisation de 143 minutes) = " << delai1.toString() << endl;
        Moment delai2(delai1); // constructeur de copie
        cout << "delai2 (copie de delai1) = " << delai2.toString() << endl;
        Pause();
    }
    ...
    cout << endl << "(2) ***** Constructeur d'initialisation (date --> SANS heure) et getters ***************" << endl;
    {
        ...
        cout << "date (14/09/2013) = " << date.toString() << endl;
    ...
    cout << endl << "(3) ***** Constructeur d'initialisation (date --> AVEC heure) et getters ***************" << endl;
    {
        ...
        cout << "date (14/09/2013 17h11) = " << date.toString() << endl;
        cout << "Annee = " << date.getYear() << endl;
        cout << "Mois = " << date.getMonth() << endl;
        cout << "Jour = " << date.getDay() << endl;
        cout << "Heure = " << date.getHour() << endl;
    ...
    cout << endl << "(4) ***** Test de setters (pour la date) ***************" << endl;
    {
        ...
        cout << "date (apres) = " << date.toString() << endl;
    ...
    cout << endl << "(5) ***** Constructeur de copie (Date) ***************" << endl;
    {
        ...
        cout << "date (14/09/2013) = " << date.toString() << endl;
        cout << "date2 (copie de date) = " << date2.toString() << endl;
    ...
    {
        cout << "Date et heure actuelle (1) = " << Moment::now().toString() << endl;
        Moment date(Moment::now());
        cout << "Date et heure actuelle (2) = " << date.toString() << endl;
        Pause();
    }
    ...
    cout << endl << "(10) ***** Test de l'operateur + (Moment) ***************" << endl;
    {
        ...
        cout << "date = " << date.toString() << endl;
        cout << "delai = " << delai.toString() << endl << endl;
        cout << "--> d = date + delai;" << endl;
        d = date + delai;
        cout << "date = " << date.toString() << endl;
        cout << "delai = " << delai.toString() << endl;
        cout << "d = " << d.toString() << endl;
    ...
    cout << endl << "(11) ***** Test de l'operateur - (Moment) ***************" << endl;
    {
        ...
        cout << "date1 = " << date1.toString() << endl;
        cout << "date2 = " << date2.toString() << endl;
        cout << "d1 = " << d1.toString() << endl;
